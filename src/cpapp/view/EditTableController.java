...
public class EditTableController implements Initializable {
    ...
    private ObservableList<CPoint> olist;
    @Override
    ...
    private void initTableList(){
        olist = FXCollections.observableList(data.cpTrack.points);
        tableView.setItems(olist);
    }

    private void updateObservableListProperties(TableColumn cellName, TableColumn cellId) {
        cellName.setOnEditCommit(new EventHandler<CellEditEvent<CPoint, String>>() {
            @Override public void handle(CellEditEvent<CPoint, String> t) {
                ((CPoint) t.getTableView().getItems().get(
                        t.getTablePosition().getRow())).setName(t.getNewValue());
            }
        });
        cellId.setOnEditCommit(new EventHandler<CellEditEvent<CPoint, String>>() {
            @Override public void handle(CellEditEvent<CPoint, String> t) {
                ((CPoint) t.getTableView().getItems().get(
...
//.......................................................................................
    ...
    public static class EditingCell extends TableCell<CPTrack, String> {
